    ...
    [
            ...
            [
                ...
                html.Div([
                    ...
                    dcc.Markdown(id = "details_link1", children = ["Link: {}".format(comments["tweetURL"][0])], style = {"font-size": "14px"}),
                ...
                html.Div([
                    ...
                    dcc.Markdown(id = "details_link2", children = ["Link: {}".format(comments["tweetURL"][1])], style = {"font-size": "14px"}),
                ...
                html.Div([
                    ...
                    dcc.Markdown(id = "details_link3", children = ["Link: {}".format(comments["tweetURL"][2])], style = {"font-size": "14px"}),
